...
public class NeedToTake {
    public static void main(String[] args) {
        ...
        switch(input){
            case 1:
                inFile = "adjlist.in";
                outFile = "needtotake.out";
                specialFile = "needtotake.in";
                break;
        ...
        HashSet<CourseNode> coursesNeededToTake = nav.classesNeedToTake(specialFile);

        for(CourseNode s: coursesNeededToTake){
            StdOut.println(s.getName());
        }
    }
